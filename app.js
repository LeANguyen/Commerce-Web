...
// cart_item
app.post('/cart_item/current_cart/client_id/:client_id/item_id/:item_id', cart_item_db.addItemIntoCurrentCart)
app.get('/cart_items/current_cart/client_id/:client_id', cart_item_db.getAllItemFromCurrentCart)
app.get('/cart_item/current_cart/client_id/:client_id/item_id/:item_id', cart_item_db.getItemFromCurrentCartByItemID)
app.put('/cart_item/current_cart/client_id/:client_id/item_id/:item_id', cart_item_db.updateItemQuantityFromCurrentCart)
app.delete('/cart_item/current_cart/client_id/:client_id/item_id/:item_id', cart_item_db.deleteItemFromCurrentCart)
...
app.delete('/image', (req, res) => {
    const path = __dirname + '/public/uploaded_images/item' + req.query.id + '.png'
    fs.unlink(path, (err) => {
        if (err) {
            console.error(err)
            return
